...
const Contact = () => {
  return (
    <div className='mt-40 bg-black rounded-custom-56 p-10'>
      <p className='ml-12 text-white text-[64px] font-normal'>
      Ready to create something cool and need a 
      frontend partner?
      </p>  
      <div className='flex flex-row py-6 px-8 mt-16 justify-center items-center'>
          <Image src={projects} alt="projects info pic"/>
          <p className='ml-12 text-green-200 text-[56px] font-normal'>
